...
@section('content')
	...
	<div class="container" style="margin-bottom: 20px; border-bottom: 1px solid lightgray;"><h1 style="font-size: 50px;width: 100%;">Books for you</h1></div>
	...
	<div class="container" style="border-bottom: 1px solid lightgray;"><h1 style="font-size: 50px;width: 100%;">This week's author</h1></div>
	<section class="fh5co-about-me" style="margin-top: 90px;">
